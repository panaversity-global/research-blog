    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-100">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16 max-w-4xl">
        ...
        <div className="space-y-8">
          ...
          <Card className="card">
            <CardHeader>
              <CardTitle className="text-xl font-bold text-gray-900">Information We Collect</CardTitle>
            </CardHeader>
          ...
          <Card className="card">
            <CardHeader>
              <CardTitle className="text-xl font-bold text-gray-900">How We Use Your Information</CardTitle>
            </CardHeader>
            <CardContent className="space-y-4 text-gray-600">
          ...
          <Card className="card">
            <CardHeader>
              <CardTitle className="text-xl font-bold text-gray-900">Information Sharing</CardTitle>
            </CardHeader>
            <CardContent className="space-y-4 text-gray-600">
          ...
          <Card className="card">
            <CardHeader>
              <CardTitle className="text-xl font-bold text-gray-900">Cookies and Tracking Technologies</CardTitle>
            </CardHeader>
            <CardContent className="space-y-4 text-gray-600">
          ...
          <Card className="card">
            <CardHeader>
              <CardTitle className="text-xl font-bold text-gray-900">Data Security</CardTitle>
            </CardHeader>
            <CardContent className="space-y-4 text-gray-600">
          ...
          <Card className="card">
            <CardHeader>
              <CardTitle className="text-xl font-bold text-gray-900">Your Rights and Choices</CardTitle>
            </CardHeader>
            <CardContent className="space-y-4 text-gray-600">
              ...
              <p className="text-sm">
                ...
                <a href="mailto:privacy@techblog.com" className="text-blue-600 hover:text-blue-700 underline">
          ...
          <Card className="card">
            <CardHeader>
              <CardTitle className="text-xl font-bold text-gray-900">International Data Transfers</CardTitle>
            </CardHeader>
            <CardContent className="space-y-4 text-gray-600">
              <p>
          ...
          <Card className="card">
            <CardHeader>
              <CardTitle className="text-xl font-bold text-gray-900">Changes to This Privacy Policy</CardTitle>
            </CardHeader>
            <CardContent className="space-y-4 text-gray-600">
              <p>
