        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {featuredPosts.map((post) => (
              <Card key={post.slug} className="bg-slate-800/50 border-slate-700/50 hover:bg-slate-800/70 transition-all duration-300 hover:shadow-xl hover:shadow-blue-500/10 group">
                <CardHeader className="pb-4">
                  ...
                  <CardTitle className="text-xl text-white group-hover:text-blue-400 transition-colors duration-200 line-clamp-2">
                ...
                <CardContent className="pt-0">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-sm text-slate-400">{post.frontmatter.author}</span>
                    </div>
          ...
          <div className="text-center mt-12">
            <Button asChild variant="outline" size="lg" className="border-slate-400 text-slate-300 hover:bg-slate-800/50 px-8 py-3">
              <Link href="/blog">
                View All Articles
                <ArrowRight className="ml-2 h-5 w-5" />
              </Link>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center p-6">
              ...
              <p className="text-slate-400">Learn from industry experts and experienced developers</p>
            </div>
            ...
            <div className="text-center p-6">
              ...
              <h3 className="text-xl font-semibold text-white mb-3">Practical Tutorials</h3>
              <p className="text-slate-400">Step-by-step guides and real-world examples</p>
            </div>
            ...
            <div className="text-center p-6">
              ...
              <h3 className="text-xl font-semibold text-white mb-3">Latest Trends</h3>
              <p className="text-slate-400">Stay updated with cutting-edge technologies</p>
            </div>
          </div>
        </div>
      </section>
